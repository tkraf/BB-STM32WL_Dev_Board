// Generated by SolidPython 1.1.3 on 2024-10-28 22:29:18
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.4000000000) {
					offset(r = 1.0000000000) {
						import(file = "C:/Users/tkraf/Documents/GitHub/BB-STM32WL_Dev_Board/BB-STM32 Dev Board-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.4000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "C:/Users/tkraf/Documents/GitHub/BB-STM32WL_Dev_Board/BB-STM32 Dev Board-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
